...
NON_SQUARE_1 = np.array([1, 2])
NON_SQUARE_2 = np.array([[1, 2, 3], [4, 5, 6]])
NON_SQUARE_3 = np.array([[1, 2, 3, 4], [5, 6, 7, 8]])
NON_SQUARE_4 = np.array([[1, 2], [3, 4], [5, 6]])
NON_SQUARE_5 = np.array([[1, 2], [3, 4], [5, 6], [7, 8]])
NON_SQUARES: tuple[ndarray, ...] = (NON_SQUARE_1, NON_SQUARE_2, NON_SQUARE_3, NON_SQUARE_4, NON_SQUARE_5)
...
class TestRotateImg:
    ...
    def test_rotate_square_deg(self, img, degrees, expected):
    ...
    def test_rotate_square_single_value_img(self, img, degrees, expected):
        np.testing.assert_equal(rotate_img(img, degrees), expected)
    ...
    @pytest.mark.filterwarnings("ignore")
    def test_rotate_square_empty_img(self, img, degrees, expected):
        with pytest.warns(UserWarning, match=r".*empty image.*"):
            np.testing.assert_equal(rotate_img(img, degrees), expected)

    def test_rotate_square_single_value_img_warning(self):
        with pytest.warns(UserWarning, match=r".*singular image.*"):
            rotate_img(IMG11, 90)

    def test_rotate_square_empty_img_warning(self):
        with pytest.warns(UserWarning, match=r".*empty image.*"):
            rotate_img(IMG00, 90)
...
class TestRotateImgSquare(TestRotateImg):
    ...
    def test_rotate_square_nonsquare_mat(self, img, degrees, expected):
