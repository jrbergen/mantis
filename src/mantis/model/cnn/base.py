...
from mantis import DIR_APP, DIR_TMP
from mantis.dataset.base.dataset_configs_base import ImageDataSetConfig
...
from mantis.model.base import SplitDataSet, DefectDetectionModel
