...
from tmap_defectdetector import DIR_TMP, DIR_DATASETS
from tmap_defectdetector.dataset.base.dataset_configs_base import FALLBACK_LABEL_CATEGORY
...
from tmap_defectdetector.model.base import SplitDataSet
